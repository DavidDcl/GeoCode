...
function ReservationModal({
  ...
  return (
    <div>
      {reservation && (
        <div className="fixed inset-0 h-screen z-30 flex items-center justify-center bg-secondary bg-opacity-40 ">
          <div className="bg-primary rounded-xl shadow-md lg:w-1/2 w-80 flex flex-col">
            <h3 className="bg-blue p-3 rounded-t-xl text-xl text-primary font-bold">
              Réservation :
            </h3>
          ...
          <div className="bg-primary rounded-xl shadow-md w-80 flex flex-col">
            ...
            <div className="rounded-lg flex flex-col p-3">
              <div className="flex gap-4">
                <h3 className="text-blue font-bold">Date:</h3>
                <p className="text-secondary font-bold">
                  {dataConfirmation.date.split("T")[0]}
                </p>
              </div>
              <div className="flex gap-4">
                <h3 className="text-blue font-bold">Heure:</h3>
                <p className="text-secondary font-bold">
                  {dataConfirmation.start_time.split(":00")}
                </p>
              </div>
              <div>
                <h3 className="text-blue font-bold">Station:</h3>
                <p className="text-secondary font-bold">
                  {dataConfirmation.nom_station}
                </p>
              </div>
              <div className="flex gap-4">
                <h3 className="text-blue font-bold">Borne:</h3>
                <p className="text-secondary font-bold">
                  {dataConfirmation.serial}
                </p>
              </div>
              <div className="flex gap-4">
                <h3 className="text-blue font-bold">Total:</h3>
                <p className="text-secondary font-bold">
                  {dataConfirmation.price} €
                </p>
              </div>
            </div>
          </div>
